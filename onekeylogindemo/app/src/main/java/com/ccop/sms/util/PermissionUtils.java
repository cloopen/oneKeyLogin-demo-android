...
import com.ccop.sms.OklApplication;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(OklApplication.getApplication().getPackageName());
    }
    ...
    public static List<String> getPermissions(final String packageName) {
        PackageManager pm = OklApplication.getApplication().getPackageManager();
        try {
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(OklApplication.getApplication(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + OklApplication.getApplication().getPackageName()));
        OklApplication.getApplication().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
     ...
     * Start request.
     */
    public void request(Activity context) {
    ...
    private void startPermissionActivity(Activity context) {
        mPermissionsDenied = new ArrayList<>();
        mPermissionsDeniedForever = new ArrayList<>();
//        PermissionActivity.start(OklApplication.getApplication());
        if (sInstance.mPermissionsRequest != null) {
            int size = sInstance.mPermissionsRequest.size();
            if (size <= 0) {
                return;
            }
            context.requestPermissions(sInstance.mPermissionsRequest.toArray(new String[size]), 1);
        }
    }
